...
#----------------------------------------------
To run Replay test (only replay data) based on UHD Python API (TX only):
...
#----------------------------------------------
To run RF Data recorder based on UHD Python API (rx only):
...
- First, change config parameters in JSON or YAML file: config_rf_data_recording_api.json
