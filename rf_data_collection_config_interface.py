...
def read_config_files(rf_data_acq_config_file: str):
    ...
    if extension == ".yaml":
        with open(os.path.join(os.path.dirname(__file__), rf_data_acq_config_file), "r") as file:
...
def generate_rf_data_collection_configs(rf_data_acq_config_file: str, enable_console_logging: bool):
    """
...
if __name__ == "__main__":
    ...
    rf_data_acq_config_file = "config_rf_data_recording_api.json"

    variations_map1 = generate_rf_data_collection_configs(
        rf_data_acq_config_file, enable_console_logging=True
    )

    rf_data_acq_config_file = "config_rf_data_recording_api.yaml"

    variations_map2 = generate_rf_data_collection_configs(
        rf_data_acq_config_file, enable_console_logging=True
    )
