...
#----------------------------------------------
To run the replay data tranmitter, use the following command:
...
#----------------------------------------------
To run the RF Data recorder (Rx only), use the following command:
...
#----------------------------------------------
To run the main RF data recording api (TX + RX, RX only, TX only)
- First, change config parameters in YAML file (default) or JSON file: config_rf_data_recording_api.yaml. Then, run the following caommand:
python3.9 main_rf_data_recording_api.py
- You can pass the config file to main function:
